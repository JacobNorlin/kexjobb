...
public class MainActivity extends Activity {
	...
	BTClient btClient;
	ZephyrProtocol zephyrProtocol;
	NewConnectedListener newConnListener;
		...
		if (btnConnect != null)
		{
			btnConnect.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					newConnListener = new NewConnectedListener(Newhandler,Newhandler);
					btClient.addConnectedEventListener(newConnListener);
		...
		if (btnDisconnect != null)
		{
			btnDisconnect.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					btClient.removeConnectedEventListener(newConnListener);
